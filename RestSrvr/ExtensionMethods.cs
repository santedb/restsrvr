...
namespace RestSrvr
{
    ...
    public static class ExtensionMethods
    {
        ...
        /// <returns></returns>
        public static ContentType GetMostPreferredResponseContentType(this HttpListenerRequest me, params string[] supportedMediaTypes) => me.AcceptTypes?
                .Select(x => new System.Net.Mime.ContentType(x))
